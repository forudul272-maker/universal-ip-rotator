...
echo -e "${GREEN}✓ Interface:${NC} ${ETH}"
echo -e "${GREEN}✓ Server IP:${NC} ${VPS_IP}\n"

# ==============================================================================
#                  🔐 CLOUDFLARE LICENSE & ACCESS VERIFICATION
# ==============================================================================
# ⚠️ LIVE CLOUDFLARE WORKER URL:
...
cat << 'EOF_BOT_CODE' > "${INSTALL_DIR}/bot.py"
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
================================================================================
...
systemctl restart foridul-ip-rotator.service
...
if systemctl is-active --quiet foridul-ip-rotator.service; then
    ...
    echo -e "${CYAN}• Server IP:${NC} ${YELLOW}${VPS_IP}${NC}"
